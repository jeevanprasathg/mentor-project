...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO tbl_staff  VALUES (null,'$empid','$staffname','$desgination','$email','$number','$joining','$username','$password','$password2')";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="addstaff.php" method="POST"  >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="staffname" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
